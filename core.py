    ...
    try:
        ...
        try:
            ...
            try:
                ...
                checkout_url = cart_resp_data["data"]["result"]["cart"]["checkoutUrl"]
            ...
            try:
                ...
                _p2_session = _p2_data.get('session', {})
                _p2_negotiate = _p2_session.get('negotiate', {})
                _p2_result = _p2_negotiate.get('result', {})
                _p2_result_type = _p2_result.get('__typename', '')
                ...
                if _p2_result_type == 'CheckpointDenied':
                    ...
                    _neg_errors = _p2_negotiate.get('errors', [])
                    _neg_err_msgs = [e.get('message', str(e)) for e in _neg_errors[:3]]
                    return False, f"Proposal 2 negotiation failed: {'; '.join(_neg_err_msgs)}", gateway, total_price, currency
                elif _p2_result_type != 'NegotiationResultAvailable':
